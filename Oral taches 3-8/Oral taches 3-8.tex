...
Ce procédé est très intéressant à réaliser mais n'est encore qu'à ses débuts et comporte plusieurs problèmes de réalisation à l'échelle industrielle. Le faible rendement de la réaction (de l'ordre de 7-10 \%), son coût élevé pour produire de grandes quantités de \ce{H2}, ou encore la nécessité de disposer de grandes surfaces de cultures font que ce procécé n'est pas encore adapté à l'échelle industrielle.
\newline

Une autre variante de ce procédé est la production de biohydrogène à l'aide de bactéries. Celles-ci décomposent les hydrocarbures présents dans les eaux usées, formant ainsi du \ce{H2} et du \ce{CO2} (pouvant être isolé facilement). Un autre sorte de bactéries, la Cyanothece 51142 est capable de fixer l'azote en présente de \ce{O2} et de produire ainsi du \ce{H2}. Le seul souci est qu'il n'exite pas encore de solution pour transporter cet hydrogène.
\newline
