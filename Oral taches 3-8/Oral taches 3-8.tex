...
\title{Oral sur les tâches 3 et 8}
\author{Groupe 1225}
\date{\today}
...
---> Présentation du mindmap.

---> Présentation des gaz à effet de serre.

Nous choisissons comme cause d'impact le rejet de \ce{CO2}.
\newline
...
S'il y a une fuite au niveau du premier réacteur ou dans le four, 
...
nous rejetons envrion $1950\si{\tonne}$ de \ce{CO2}.
...
de diminuer les quantités de dioxyde de carbone libérées dans l'atmosphère et ainsi réduire l'impact du procédé sur l'environnement.
...
Ce procédé est plus compliqué à réaliser que le vaporeformage. Egalement plus coûteux, il n'est intéressant que lorsque les prix du pétrole augmentent. La gazéification à l'eau rejette aussi beaucoup de \ce{CO2}.
\newline
...
Ce procédé est très intéressant à réaliser mais n'est encore qu'à ses débuts et comporte plusieurs problèmes de réalisation à l'échelle industrielle. Le faible rendement de la réaction (de l'ordre de 7-10 \%), son coût élevé pour produire de grandes quantités de \ce{H2}, ou encore la nécessité de disposer d'une grande surface de cultures font que ce procécé n'est pas encore adapté à l'échelle industrielle.
\newline

Une autre variante de ce procédé est la production de biohydrogène à l'aide de bactéries. Celles-ci décomposent les hydrocarbures présents dans les eaux usées, formant ainsi du \ce{H2} et du \ce{CO2} (pouvant être isolé facilement). Les inconvénients sont identiques à ceux de la production à l'aide d'algues. Le procédé requiert une importante surface d'électrodes.

Un autre sorte de bactéries, la Cyanothece 51142 est capable de fixer l'azote en présente de \ce{O2} et de produire ainsi du \ce{H2}. Le seul souci est qu'il n'exite pas encore de solution pour transporter cet hydrogène.
\newline
...
Dans ce cas-là, le rejet de \ce{CO2} pour produire les $5,7\si{\giga\watt}$ nécessaires 
...
Par ailleurs, nous pouvons encore réduire l'impact environnemental en récupérant le \ce{CO2} rejeté par le procédé.
