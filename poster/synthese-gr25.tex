...
{\textsc{\small Cédric de Bellefroid - Cyril Denos - David Dispas  - Cassian Libeer  - Tim Malengreau - Arnaud Paquet - John de Wasseige}} % Author names and institution
...
\headerbox{Résumé}{name=resume,column=1,row=0}{
...
\headerbox{Tâche 1}{name=tache1,column=0,row=0}{
...
\textbf{Emissions}\\
\\
$CO_{2}$ : $1950$  $\frac{Tonnes}{Jour}$ \\

$T\ensuremath{^\circ} _{\text{réformateur primaire}} \searrow$ : $CO_{2}\searrow$\\
\\
$H_{2}0$ : $Xtonnes?$\\

$H_{2}0\searrow$ : $T\ensuremath{^\circ} _{refermateur primaire} \nearrow$\\
