...
Afin de maintenir les réacteurs à température constante, on refroidit ceux-ci avec de l'eau.
...
\begin{equation}
	\Delta H_{reaction} = \Delta H_{f, \ce{NH3}, 773K} 
	- \frac{1}{2} \Delta H_{f, \ce{N2}, 773K}
	- \frac{3}{2} \Delta H_{f, \ce{H2}, 773K}
...
\begin{equation}
	\Delta H_{f, T2} = \Delta H_{f, T1} + \int_{T1}^{T2} C_p \, \mathrm{d}T
