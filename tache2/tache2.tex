...
\begin{equation}
\dot{n}_{\ce{Ar},\text{in}}=\dot{n}_{\ce{Ar},purge}=[\ce{Ar}]_{\text{purge}} \dot{n}_{\text{purge}}
\end{equation}
...
\begin{equation}
[Ar]_{\text{out}} \dot{n}_{\text{out}}=[Ar]_{\text{recyclage}} \dot{n}_{\text{recyclage}}
\end{equation}
...
\[
K_p=\frac{{[\ce{NH3}]_{\text{out}}}^2}{[\ce{N2}]_{\text{out}}{[\ce{H2}]_{\text{out}}}^3} \cdot p^{-2} = 
...
Nous obtenons directement $[\ce{Ar}]_{\text{purge}}$ en injectant 
le résultat dans la première équation. 
$[\ce{Ar}]_{\text{purge}}$ est égal à $[\ce{Ar}]_{\text{recyclage}}$ 
...
\[ \dot{n}_{\ce{Ar},out}=[\ce{Ar}]_{\text{recyclage}}\dot{n}_{\text{total,recyclage}} \]

\[ 
\dot{n}_{\ce{Ar},out}\underset{(3)} = 
[\ce{Ar}]_{\text{recyclage}}(\dot{n}_{\text{total,out}}-\dot{n}_{\ce{NH3},\text{out}}) 
\]
