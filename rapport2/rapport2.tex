...
\begin{equation*}
	\Delta G_{\text{reaction}}^{\circ} = \Delta H_{\text{reaction}}^{\circ} 
	- T \, \Delta S_{\text{reaction}}^{\circ}
\end{equation*}
...
La figure \ref{fig:flow} présente un flow-sheet simplifié du processus de production
