...
\begin{tabular}{|l|c|c|c|r|}
  ...
  n_{CH_4}-\xi & n_{H_2O}-\xi & \xi & $3 \xi$ & n_{CH_4} + n_{H_2O} + $2 \xi$\\
  \hline
\end{tabular}

Pour la deuxième équation, avec un certain \eta:\\
	\begin{equation}
	\ce{CO + H2O <-> CO2 + H2}
	\end{equation}\\
\begin{tabular}{|l|c|c|c|r|}
  ...
  \hline
   \xi & n_\ce{H_2O}-\xi & 0 & $3\xi$ & n_{H_2O}+$3\xi$\\
   \xi-\eta & n_\ce{H_2O}-\xi-\eta & \eta & $3\xi +\eta$ & n_{H_2O}+$3\xi$\\
  \hline
\end{tabular}\\
...
On obtient donc finalement un système de quatre équations à 4 inconnues - où 2 d'entre elles ne sont autres que les débits d'\ce{H2O} et de \ce{CH4} -, que nous pouvons résoudre sur Matlab pour plus de facilité (voir annexe). Comme prévu, ces quantités dépendent de T et de la masse d'ammoniac voulue à la sortie.
