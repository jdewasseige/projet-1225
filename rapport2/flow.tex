...
\node [block, right = 2em of primaire] (four) {Four: Combustion \ce{CH4} (rendement $75\%$) 
($\simeq 1300K$)\\
	\ce{CH4 + 2O2 -> CO2 + 2H2O}};
\node [cloud, above = 3em of four] (O2) {\ce{O2}};
\node [cloud, above = 3em of primaire] (CH4) {\ce{CH4}};
...
\path [line] (primaire) -- node[anchor = east] {\ce{H2} \ce{CH4} \ce{CO2} \ce{CO} \ce{H2O}}(s	econdaire);
